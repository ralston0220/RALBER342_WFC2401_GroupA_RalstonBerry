// Lesson 1: Introduction to the DOM these are connected to each other
...
const welcomeMessage = () => {
    ...
    document.getElementById('welcome-message').textContent = `🤸🏾‍♀️ Welcome to Your Fitness Tracker 🥗 Today is ${today}`;
};
welcomeMessage();
